import os, sys, VigenereCipher

#Enter the file you want to encrypt and the key
File = (input("What is the file that you want to encrypt/decrypt with the vigenere cipher ? \n"))
...
if Mode.startswith('D') :
    ...
    NewText = VigenereCipher.DecryptVigenere(Content,Key)
elif Mode.startswith('E') :
    print('You will encrypt your file with the key : %s' % (Key))
    NewText = VigenereCipher.EncryptVigenere(Content,Key)
else : 
